...
from data_prep_sentences import DataRawLoader
import json
...
def get_token_saliencies(sentence, label, handler, criterion, tokenizer):
    ...
    Note that the label should be the true label
    '''
...
if __name__ == '__main__':
    ...
    commandLineParser.add_argument('--end_ind', type=int, default=100, help="data point index to end at")
    ...
    # Get all data
    myDataLoader = DataRawLoader()
    sentence_list, labels = myDataLoader.get_test()
